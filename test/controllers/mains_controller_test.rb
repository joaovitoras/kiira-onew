...
class MainsControllerTest < ActionController::TestCase
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post :create, main: { heroinfo: @main.heroinfo, newscontent: @main.newscontent, titlenews: @main.titlenews }
    end
  ...
  test "should update main" do
    patch :update, id: @main, main: { heroinfo: @main.heroinfo, newscontent: @main.newscontent, titlenews: @main.titlenews }
    assert_redirected_to main_path(assigns(:main))
  end
